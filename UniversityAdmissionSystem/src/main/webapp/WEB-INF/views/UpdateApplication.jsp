...
<body class="container">
    ...
    <div class="container card  mt-5">
        <div class="containercard-body">
            <center>
                <h1 class="mt-2 mb-2">Update the Application</h1>
            </center>
...
<br>
                    ...
                    <label for="name" class="col-sm-2 col-form-label">Enter Application Id</label>
                    <div class="col-sm-10">
                    <input type="number" name="applicationId" class="form-control">                  
                     ...
                     <div class="form-group row">
                    <label for="name" class="col-sm-2 col-form-label">Date of Interview</label>
                    <div class="col-sm-10">
