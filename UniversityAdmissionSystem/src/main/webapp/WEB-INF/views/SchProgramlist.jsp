...
<body class="container" background="../resources/image/s.jpg"
	background-size="cover">
	<div>
	...
	<div class="col-md-auto col-lg-6 col-md-offset-4 form-container mt-4">
		<div class="card-body">
			<div class="form-group">
				<form action="./schproglist" method="post">

					<div class="form-group row">
						<label for="name" class="col-sm-2 col-form-label">Program Name</label>
						<div class="col-sm-10">
							<input type="text" name="ProgrammName"
								class="form-control">
						</div>
					</div>

					<input type="submit" value="Scheduled_programms_list">
