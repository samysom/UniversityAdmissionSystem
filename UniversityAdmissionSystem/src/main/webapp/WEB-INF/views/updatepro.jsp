...
<body class="container">
    ...
    <div class="container card  mt-5">
        <div class="containercard-body">
            <center>
                <h1 class="mt-2 mb-2">Update the Program</h1>
            </center>
...
<label for="name" class="col-sm-2 col-form-label">Enter Description</label>
                    ...
                    <div class="form-group row">
<label for="name" class="col-sm-2 col-form-label">Applicant Eligibility</label>
                    <div class="col-sm-10">
                    <input type="text" name="Applicant_eligibility" class="form-control">
                         </div></div>
...
<label for="name" class="col-sm-2 col-form-label">Degree Certificate Offered</label>
                    <div class="col-sm-10">
                    <input type="text" name="Degree_certificate_offered" class="form-control">                 
                         </div></div>
