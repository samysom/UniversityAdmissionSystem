...
<title>Delete Scheduled Program</title>
</head>
</head>
<body class="container" background="../resources/image/deletepg.jpg" background-size="cover">
	<div>
...
<form action="./deletesch" method="post">




<div class="form-group row">
                    <label for="name" class="col-sm-2 col-form-label"><b>Scheduled Program Id</b></label>
                    <div class="col-sm-5">
